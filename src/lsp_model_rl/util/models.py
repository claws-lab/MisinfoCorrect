...
class BiEncoderAttentionWithRationaleClassification(nn.Module):
	...
	def __init__(self, hidden_dropout_prob=0.2, rationale_num_labels=2, empathy_num_labels=3, hidden_size=768, attn_heads = 1):
		...
		self.apply(self._init_weights)# ../../Empathy-Models/Pretraining-Tasks/pretrained-talklife-roberta-seeker/checkpoint-169000/

		self.seeker_encoder = SeekerEncoder.from_pretrained(
								"roberta-base", # Use the 12-layer BERT model, with an uncased vocab.
								output_attentions = False, # Whether the model returns attentions weights.
								output_hidden_states = False) # ../../Empathy-Models/Pretraining-Tasks/pretrained-talklife-roberta-response/checkpoint-293000/
